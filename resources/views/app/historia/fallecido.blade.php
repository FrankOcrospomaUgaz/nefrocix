...
{!! Form::model($modelo, $formData) !!}	
	...
	<div class="form-group">
		{!! Form::label('fallecido', 'fallecido:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
		<div class="col-lg-4 col-md-4 col-sm-4">
			{!! Form::select('fallecido', array("N"=>"NO", "S"=>"SI"), null, array('class' => 'form-control input-xs', 'id' => 'fallecido', "rows" => "3")) !!}
		</div>
	</div>
	<div class="form-group">
		{!! Form::label('motivo', 'Motivo:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
		<div class="col-lg-8 col-md-8 col-sm-8">
			{!! Form::textarea('motivo', null, array('class' => 'form-control input-xs', 'id' => 'morivo', "rows" => "3")) !!}
		</div>
	</div>
	<div class="form-group">
