				...
				<div class="box-header">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								{!! Form::label('estado', 'Historia Inicial:') !!}
								{!! Form::select('estado', array(""=>"---TODOS---", "P"=>"PENDIENTE", "S"=>"COMPLETA"), null, array('class' => 'form-control input-xs', 'id' => 'estado','onchange' =>'buscar(\''.$entidad.'\')')) !!}
							</div>
							<div class="form-group">
								{!! Form::label('estado3', 'Historia de Enfermeria:') !!}
								{!! Form::select('estado3', array(""=>"---TODOS---", "P"=>"PENDIENTE", "S"=>"COMPLETA"), null, array('class' => 'form-control input-xs', 'id' => 'estado3','onchange' =>'buscar(\''.$entidad.'\')')) !!}
							</div>
							<div class="form-group">
