...
{!! Form::model($modelo, $formData) !!}	
	...
	<div class="form-group">
		...
		<div class="col-lg-8 col-md-8 col-sm-8">
			{!! Form::textarea('observaciones', null, array('class' => 'form-control input-xs', 'id' => 'observaciones', "rows" => "3")) !!}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-12 col-md-12 col-sm-12 text-right">
			{!! Form::button('<i class="fa fa-check fa-lg"></i> Guardar', array('class' => 'btn btn-success btn-sm', 'id' => 'btnGuardar', 'onclick' => 'guardar(\''.$entidad.'\', this)')) !!}
