...
{!! Form::model($compra, $formData) !!}	
	...
	<div class="col-lg-5 col-md-5 col-sm-5">
		<div class="form-group">
			...
			<div class="col-lg-8 col-md-8 col-sm-8">
				{!! Form::select('tipodocumento_id', array("6"=>"FACTURA DE COMPRA", "7"=>"BOLETA DE COMPRA", "12" => "TICKET"), null, array('style' => 'background-color: #D4F0FF;' ,'class' => 'form-control', 'id' => 'tipodocumento_id', 'onchange' => 'generarNumero(this.value);')) !!}
			</div>
		</div>
		<div class="form-group" style="display: none;">
			{!! Form::label('credito', 'Credito:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-8 col-md-8 col-sm-8">
				{!! Form::select('credito', $cboCredito, 'N', array('style' => 'background-color: #D4F0FF;' ,'class' => 'form-control', 'id' => 'credito', 'onchange' => 'cambiar();')) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('numerodocumento', 'Nro Doc:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-3 col-md-3 col-sm-3">
				{!! Form::text('serie', null, array('class' => 'form-control', 'id' => 'serie', 'placeholder' => 'serie')) !!}
			</div>
			<div class="col-lg-5 col-md-5 col-sm-5">
				{!! Form::text('numerodocumento', null, array('class' => 'form-control', 'id' => 'numerodocumento', 'placeholder' => 'numerodocumento')) !!}
			</div>
		</div>
		<div class="form-group" style="display: none;">		
			{!! Form::label('numerodias', 'Nro Dias:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-2 col-md-2 col-sm-2">
				{!! Form::text('numerodias', 0, array('style' => 'background-color: #FFEEC5;','class' => 'form-control', 'id' => 'numerodias')) !!}				
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('afecto', 'Afecto:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-8 col-md-8 col-sm-8">
				{!! Form::select('afecto', $cboAfecto, null, array('class' => 'form-control', 'id' => 'afecto')) !!}
			</div>
		</div>	
		<div class="form-group">
			{!! Form::label('total', 'Total:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-3 col-md-3 col-sm-3">
				{!! Form::text('total', number_format(0, 2, '.', ''), array('style' => 'background-color: #FFEEC5;','class' => 'form-control numerin', 'id' => 'total' )) !!}
			</div>
			{!! Form::label('igv', 'Igv:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
			<div class="col-lg-3 col-md-3 col-sm-3">
				{!! Form::text('igv', '0.00', array('style' => 'background-color: #FFEEC5;','class' => 'form-control numerin', 'id' => 'igv' )) !!}
			</div>
		</div>
		<div id="opcEmpresa">
			<div class="form-group">
				...
				<div class="col-lg-8 col-md-8 col-sm-8">
	    			{!! Form::text('ccruc','', array('class' => 'form-control datocaja', 'id' => 'ccruc', 'maxlength' => '11')) !!}
	    		</div> 
		    </div>
		    <div class="form-group">
	    		{!! Form::label('ccrazon', 'Razón:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
				<div class="col-lg-8 col-md-8 col-sm-8">
	    			{!! Form::text('ccrazon','', array('class' => 'form-control datocaja', 'id' => 'ccrazon', 'readonly' => 'readonly')) !!}
	    		</div> 
		    </div>
		    <div class="form-group" style="display: none;">
	    		{!! Form::label('ccdireccion', 'Direcc:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
				<div class="col-lg-8 col-md-8 col-sm-8">
	    			{!! Form::text('ccdireccion','-', array('class' => 'form-control datocaja', 'id' => 'ccdireccion')) !!}
	    		</div> 	
		    </div>
		</div>
		<div class="form-group" style="display: none;">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				{!! Form::text('nombrepersona', null, array('style' => 'background-color: #FFEEC5;','class' => 'form-control', 'id' => 'nombrepersona', 'placeholder' => 'Seleccione persona')) !!}
		...
		<div class="form-group" id="divDescuentokayros">
			...
			<div class="col-lg-3 col-md-3 col-sm-3" id='divfecha'>
				{!! Form::text('fecha', date('d/m/Y'), array('class' => 'form-control', 'id' => 'fecha', 'placeholder' => 'Ingrese fecha')) !!}
			</div>
			{!! Form::label('fecha2', 'Venc.:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
			<div class="col-lg-3 col-md-3 col-sm-3" id='divfecha2'>
				{!! Form::text('fecha2', date('d/m/Y'), array('class' => 'form-control', 'id' => 'fecha2', 'placeholder' => 'Ingrese fecha')) !!}
			</div>
		</div>
		<div class="form-group" style="display: none;">
			{!! Form::label('cajafarmacialabel', 'Caja farmacia:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-8 col-md-8 col-sm-8">
				{!! Form::select('cajafamarcia', $cboCajafarmacia, null, array('style' => 'background-color: #D4F0FF;' ,'class' => 'form-control', 'id' => 'cajafarmacia', 'onchange' => 'cambiar2();')) !!}
			</div>
		</div>
		...
		{!! Form::label('nombredoctor', 'Medico:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			...
			<div class="col-lg-8 col-md-8 col-sm-8">
				{!! Form::text('nombredoctor', null, array('style' => 'background-color: #FFEEC5;','class' => 'form-control', 'id' => 'nombredoctor', 'placeholder' => 'Seleccione persona' , 'readonly' =>'')) !!}
	...
	<div class="col-lg-7 col-md-7 col-sm-7">
		<div class="form-group">
			...
			<div class="col-lg-5 col-md-5 col-sm-5">
				{!! Form::text('nombreproducto', null, array('class' => 'form-control', 'id' => 'nombreproducto', 'placeholder' => 'Ingrese nombre','onkeyup' => 'buscarProducto($(this).val());')) !!}
			</div>
			<div class="col-lg-0 col-md-0 col-sm-0">
		...
		<div class="form-group" id="divProductos" style="width: 100%; overflow:auto; height:180px; border:1px outset">
			<table class='table-condensed table-hover' border='1' style="width: 100%;">
				<thead>
					<tr>
						<!--<th class='text-center' style='width:230px;'><span style='display: block; font-size:.9em'>P. Activo</span></th>-->
						<th class='text-center' style='width:300px;'><span style='display: block; font-size:.9em'>Nombre</span></th>
						<th class='text-center' style='width:70px;'><span style='display: block; font-size:.9em'>Presentacion</span></th>
						<th class='text-center' style='width:20px;'><span style='display: block; font-size:.9em'>Fracción</span></th>
						<th class='text-center' style='width:20px;'><span style='display: block; font-size:.9em'>Stock</span></th>
						<!--<th class='text-center' style='width:20px;'><span style='display: block; font-size:.9em'>P.Kayros</span></th>-->
						<!--<th class='text-center' style='width:20px;'><span style='display: block; font-size:.9em'>P.Venta</span></th>-->
						<!--<th class='text-center' style='width:20px;'><span style='display: block; font-size:.9em'>Lote</span></th>-->
					</tr>
				</thead>
		...
		<div class="form-group">
			...
			<tr>
				<!--<td><b>P.Kayros</b></td>
				<td>&nbsp</td>
				<td>{!! Form::text('preciokayros', null, array('class' => 'form-control numerin', 'id' => 'preciokayros', 'size' => '3')) !!}</td>
				<td>&nbsp</td><td>&nbsp</td><td>&nbsp</td><td>&nbsp</td>-->
				<td><b>P.Compra</b></td>
				<td>&nbsp</td>
				<td>{!! Form::text('preciocompra', null, array('class' => 'form-control numerin', 'id' => 'preciocompra','size' => '4')) !!}</td>
				<!--<td>&nbsp</td><td>&nbsp</td><td>&nbsp</td><td>&nbsp</td>
				<td><b>P.Venta</b></td>
				<td>&nbsp</td>
				<td>{!! Form::text('precioventap', null, array('class' => 'form-control numerin', 'id' => 'precioventap', 'size' => '4')) !!}</td>-->
				<td>&nbsp</td><!--<td>&nbsp</td><td>&nbsp</td><td>&nbsp</td>-->
				<td><b>Cantidad</b></td>
				<td>&nbsp</td>
				<td>{!! Form::text('cantidad', null, array('class' => 'form-control numerin', 'id' => 'cantidad', 'size' => '4', 'onkeyup' => "javascript:this.value=this.value.toUpperCase();")) !!}</td>
				<td>&nbsp</td><!--<td>&nbsp</td><td>&nbsp</td><td>&nbsp</td>-->
				<td><b>F.Vencimiento</b></td>
				<td>&nbsp</td>
				<td>{!! Form::text('fechavencimiento', null, array('class' => 'form-control', 'id' => 'fechavencimiento', 'size' => '8')) !!}</td>
				<!--<td>&nbsp</td><td>&nbsp</td><td>&nbsp</td><td>&nbsp</td>
				<td><b>Lote</b></td>
				<td>&nbsp</td>
				<td>{!! Form::text('lote', null, array('class' => 'form-control', 'id' => 'lote', 'size' => '6')) !!}</td>-->
			</tr>
	...
	<div class="form-group" style="display: none;">
		<div class="col-lg-12 col-md-12 col-sm-12" >
			...
			<div class="col-lg-5 col-md-5 col-sm-5">
				{!! Form::text('codigo', null, array('class' => 'form-control', 'id' => 'codigo', 'placeholder' => 'Ingrese codigo')) !!}
			</div>
		</div>
	</div>
	<div class="row">
...
$(document).on('change', '#afecto', function(e) {
	...
	e.stopImmediatePropagation();
	if($(this).val() == 'N') {
		$('#igv').val('0.00').attr("readonly", true);
	} else {
		var total = $("#total").val();
		if(total === "") {
			total = 0.0;
		}
		$("#igv").val(parseFloat(total).toFixed(2)*18/100);
		$('#igv').removeAttr("readonly");
	}
});
...
$(document).ready(function() {
	...
	$(".numerin").inputmask('decimal', { radixPoint: ".", autoGroup: true, groupSeparator: ",", groupSize: 3, digits: 3 });
            ...
            success: function(a) {
                ...
                if(datos.length > 0) {
	                for(c=0; c < datos.length; c++){
	                    ...
	                    /*a +="<tr style='cursor:pointer' class='escogerFila' id='"+datos[c].idproducto+"' onclick=\"seleccionarProducto('"+datos[c].idproducto+"')\"><td align='center'><span style='display: block; font-size:.9em'>"+datos[c].principio+"</span></td><td><span style='display: block; font-size:.9em'>"+datos[c].nombre+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+datos[c].presentacion+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+datos[c].fraccion+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+stock+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+datos[c].preciokayros+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+datos[c].precioventa+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+datos[c].lote+"</span></td></tr>";*/

	                    a +="<tr style='cursor:pointer' class='escogerFila' id='"+datos[c].idproducto+"' onclick=\"seleccionarProducto('"+datos[c].idproducto+"')\"><td><span style='display: block; font-size:.9em'>"+datos[c].nombre+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+datos[c].presentacion+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+datos[c].fraccion+"</span></td><td align='right'><span style='display: block; font-size:.9em'>"+stock+"</span></td></tr>";
	                }	                
	            } else {
...
function comprobarproducto () {
	...
	$.post('{{ URL::route("venta.comprobarproducto")}}', {valor: valor,_token: _token} , function(data){
		...
		if (data.trim() == 'NO') {
			...
			alertaG("Este Producto no esta en lista de venta");
            setTimeout(function () {
                $('#codigo').focus();
            },2000) 
		}else{
...
function agregarconvenio(id){
	...
	var _token =$('input[name=_token]').val();
	if(kayros.trim() == '' ){
		alertaG("Ingrese precio kayros");
            setTimeout(function () {
                $('#txtKayros').focus();
            },2000) 
	}else if(copago.trim() == '' ){
		alertaG("Ingrese copago");
            setTimeout(function () {
                $('#txtCopago').focus();
            },2000) 
	}else{
	...
	function addpurchasecart(elemento){
		...
		/*if(parseFloat(precioventa) < parseFloat(precio)){
			alertaG("Ingrese un precio de venta mayor al de compra");
	            setTimeout(function () {
	                $('#precioventap').val('').focus();
	            },2000) 
		}else*/ if(cantidad.trim() == '' ){
			alertaG("Ingrese Cantidad");
	            setTimeout(function () {
	                $('#cantidad').focus();
	            },2000) 
		} else if(cantidad.trim() == 0){
			alertaG("la cantidad debe ser mayor a 0");
	            setTimeout(function () {
	                $('#cantidad').focus();
	            },2000) 
		} else if(precio.trim() == '' ){
			alertaG("Ingrese Precio");
	            setTimeout(function () {
	                $('#preciocompra').focus();
	            },2000) 
		} else if(precio.trim() == 0){
			alertaG("el precio debe ser mayor a 0");
	            setTimeout(function () {
	                $('#preciocompra').focus();
	            },2000) 
		} else if(fechavencimiento.trim() == '' ){
			alertaG("Ingrese Fecha Vencimiento");
	            setTimeout(function () {
	                $('#fechavencimiento').focus();
	            },2000) 
		} else if(product_id=="" || product_id=="0"){
			alertaG("Debe seleccionar un producto");
	            setTimeout(function () {
	                $('#nombreproducto').focus();
	            },2000)
		} else {
			$.post('{{ URL::route("compra.agregarcarritocompra")}}', {cantidad: cantidad,precio: precio, producto_id: product_id, tipoventa: tipoventa, fechavencimiento: fechavencimiento, detalle: $('#detalle').val(),_token: _token} , function(data){
				$('#detalle').val(true);
				if(data === '0-0') {
					alertaG('No es un formato válido de cantidad.');
					$('#cantidad').val('').focus();
					return false;
				} else {
...
function guardarCompra (entidad, idboton) {
	...
	if($(IDFORMMANTENIMIENTO + '{{ $entidad }} :input[id="igv"]').val()==""){
		...
		if(parseFloat(total)<parseFloat(igv)){
			alertaG('Igv debe ser menor que total');
			return false;
		}
