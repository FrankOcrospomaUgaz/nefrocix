...
{!! Form::model($turno, $formData) !!}	
	...
	<div class="form-group">
		{!! Form::label('hora', 'Hora:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
		<div class="col-lg-9 col-md-9 col-sm-9">
			{!! Form::time('hora', null, array('class' => 'form-control input-xs', 'id' => 'hora', 'placeholder' => 'Ingrese hora')) !!}
		</div>
	</div>
	<div class="form-group">
