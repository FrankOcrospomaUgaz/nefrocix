...
{!! Form::model($configuracion, $formData) !!}	
	...
	<div class="form-group">
		...
		<div class="col-lg-9 col-md-9 col-sm-9">
			{!! Form::text('cantidad', null, array('class' => 'form-control input-xs', 'id' => 'cantidad', 'placeholder' => 'Ingrese cantidad')) !!}
		</div>
	</div>
	<div class="form-group">
...
$(document).ready(function() {
	...
	$(IDFORMMANTENIMIENTO + '{{ $entidad }} :input[id="cantidad"]').inputmask('decimal', { radixPoint: ".", autoGroup: true, groupSeparator: "", groupSize: 3, digits: 0 });
}); 
</script>