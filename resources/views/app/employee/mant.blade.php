	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="form-group">
			...
			<div class="col-lg-8 col-md-8 col-sm-8">
				{!! Form::select('workertype_id', $cboWorkertype, NULL, array('class' => 'form-control input-xs', 'id' => 'workertype_id', "onchange" => "probarSiMedico(this.value);")) !!}
			</div>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-lg-5 col-md-5 col-sm-5">
		<div class="form-group">
			{!! Form::label('dni', 'DNI/CE:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-8 col-md-8 col-sm-8">
				{!! Form::text('dni', null, array('class' => 'form-control input-xs', 'id' => 'dni', 'placeholder' => 'Ingrese DNI/CE', 'maxlength' => '8')) !!}
			</div>
		</div>
	</div>
...
<div class="row" id="divMedico">
	<div class="col-lg-5 col-md-5 col-sm-5">
		<div class="form-group">
			{!! Form::label('rne', 'RNE:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-8 col-md-8 col-sm-8">
				{!! Form::text('rne', null, array('class' => 'form-control input-xs', 'id' => 'rne', 'placeholder' => 'Ingrese RNE', 'maxlength' => '8')) !!}
			</div>
		</div>
	</div>
	<div class="col-lg-7 col-md-7 col-sm-7">
		<div class="form-group">
			...
			<div class="col-lg-7 col-md-7 col-sm-7">
				{!! Form::text('cmp', null, array('class' => 'form-control input-xs', 'id' => 'cmp', 'placeholder' => 'Ingrese CMP', 'maxlength' => '11')) !!}
			</div>
		</div>
	</div>	
	<div class="col-lg-5 col-md-5 col-sm-5">
		<div class="form-group">
			{!! Form::label('tipomedico', 'Tipo Médico:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-8 col-md-8 col-sm-8">
	...
	<div class="col-lg-7 col-md-7 col-sm-7">
		<div class="form-group">
			{!! Form::label('especialidad_id', 'Espec.:', array('class' => 'col-lg-5 col-md-5 col-sm-5 control-label')) !!}
			<div class="col-lg-7 col-md-7 col-sm-7">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		probarSiMedico("{{$employee==NULL?"":$employee->workertype_id}}");
		$(".closdat").remove();
	...
	function probarSiMedico(workertype_id) {
		$("#divMedico").hide();
		if(workertype_id === "1"||workertype_id === "29"||workertype_id === "30"||workertype_id === "31") {
			$("#divMedico").show();
		}
	}
