...
<script>
	...
	function analisisMensualesKtvTru2(){
        window.open("reporte/analisisMensualesKtvTru2?mes="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="messs"]').val()+"&anno="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="anooo"]').val(),"_blank");
    }
