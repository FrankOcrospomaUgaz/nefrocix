				...
				<div class="box-header">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								{!! Form::label('horacita', 'Turno de Citas:', array('class' => 'col-lg-7 col-md-7 col-sm-7 control-label')) !!}
								<div class="col-lg-4 col-md-4 col-sm-4">
									{!! Form::select('horacita', $cboTurno, '', array('onchange' => 'buscar(\''.$entidad.'\')', 'class' => 'form-control input-xs', 'id' => 'horacita')) !!}
								</div>
							</div> 
							<div class="form-group">
