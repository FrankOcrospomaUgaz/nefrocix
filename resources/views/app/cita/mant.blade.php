        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-1 col-md-1 col-sm-1" style="display: none;">
                    {!! Form::button('<i class="fa fa-search fa-lg"></i>', array('class' => 'btn btn-info btn-xs', 'onclick' => 'modal (\''.URL::route('medico.lista', array('listar'=>'SI')).'\', \'Lista de Médicos\', this);', 'title' => 'Buscar Médico')) !!}
        		</div>
                <div class="col-lg-1 col-md-1 col-sm-1">
                    {!! Form::button('<i class="fa fa-search fa-lg"></i>', array('class' => 'btn btn-info btn-xs', 'onclick' => 'modalHorario (\''.URL::route('horario.index', array('listar'=>'SI')).'\', \'Horarios\', this);', 'title' => 'Horarios del Médico')) !!}
                </div>
        	</div>
            <div class="form-group">
