...
if($carta !== NULL) {
	...
	$pacientecotizacion = $carta->cotizacion->paciente->dni . ' - ' . $carta->cotizacion->paciente->apellidopaterno . ' ' . $carta->cotizacion->paciente->apellidomaterno . ' ' . $carta->cotizacion->paciente->nombres;
