...
$paciente = $liquidacion->cartagarantia->cotizacion->paciente->apellidopaterno . ' ' . $liquidacion->cartagarantia->cotizacion->paciente->apellidomaterno . ' ' . $liquidacion->cartagarantia->cotizacion->paciente->nombres;
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="form-group">
                ...
                {!! Form::label('dni', 'DNI/CE:', array('class' => 'col-lg-1 col-md-1 col-sm-1 control-label')) !!}
                <div class="col-lg-2 col-md-2 col-sm-2">
