					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								{!! Form::select('estado', array('' => "---TODOS---", "H" => "HOSPITALIZADO", "F" => "FALLECIDO", "O" => "OTRO MOTIVO", "A" => "ALTA"), '', array('class' => 'form-control input-xs', 'id' => 'estado', 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
							<div class="form-group">
								{!! Form::label('mess', 'Mes:') !!}
								{!! Form::select('mess', $meses, "", array('class' => 'form-control input-xs', 'id' => 'mes', 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
                            <div class="form-group">
								{!! Form::label('anoo', 'Año:') !!}
								{!! Form::select('anoo', $anoos, "", array('class' => 'form-control input-xs', 'id' => 'anoo', 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
							<div class="form-group">
