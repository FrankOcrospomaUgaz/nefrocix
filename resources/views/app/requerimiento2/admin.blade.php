				...
				<div class="box-header">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								{!! Form::label('comentary', 'Comentario:') !!}
								{!! Form::text('comentary', null, array('class' => 'form-control input-xs', 'id' => 'comentary', 'onkeyup' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
							<div class="form-group">
								{!! Form::label('filas', 'Filas a mostrar:')!!}
								{!! Form::selectRange('filas', 1, 100, 10, array('class' => 'form-control input-xs', 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
