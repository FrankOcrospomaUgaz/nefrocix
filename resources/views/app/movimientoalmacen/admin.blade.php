				...
				<div class="box-header">
					<div class="row">
						<div class="col-xs-12">
							...
							{!! Form::button('<div class="glyphicon glyphicon-check"></div> Corregir Movimientos Salidas', array('onclick' => 'abrirModalCorregir(this);', 'class' => 'btn btn-xs btn-warning')) !!}
							{!! Form::close() !!}
						</div>
					</div>
				</div>
...
<script>
	...
	function abrirModalCorregir(btn) {
		modal ("{{ URL::route($ruta['corregirMovimientos'], array('SI')) }}" + "?fechainicio=" + $("#fechainicio").val() + "&fechafin=" + $("#fechafin").val(), "Corregir Movimientos Salidas", btn);
	}
</script>