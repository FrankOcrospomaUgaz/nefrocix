...
{!! Form::model($producto, $formData) !!}	
	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		...
		<div class="form-group">
			{!! Form::label('codigobarra', 'Código', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
		...
		<div class="form-group">
			{!! Form::label('nombrepresentacion', 'Presentación', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
			<div class="col-lg-9 col-md-9 col-sm-9">
