...
{!! Form::model($venta, $formData) !!}	
	...
	<div class="col-lg-6 col-md-6 col-sm-6">
		...
		<div class="form-group">
			...
			<div class="col-lg-7 col-md-7 col-sm-7">
				{!! Form::text('cliente', $venta->person == null ? $venta->nombrepaciente : $venta->person->apellidopaterno . ' ' . $venta->person->apellidomaterno . ' ' . $venta->person->nombres, array('class' => 'form-control input-xs', 'id' => 'cliente', 'placeholder' => 'Ingrese cliente', 'readonly' => 'readonly')) !!}
			</div>
		</div>
	...
	<div class="col-lg-6 col-md-6 col-sm-6">
		...
		@if($venta->planilla !== NULL)
			<div class="form-group">
				...
				<div class="col-lg-7 col-md-7 col-sm-7">
					{!! Form::text('planilla', $venta->planilla->apellidopaterno . ' ' . $venta->planilla->apellidomaterno . ' ' . $venta->planilla->nombres, array('class' => 'form-control input-xs', 'id' => 'planilla', 'readonly', 'readonly')) !!}
				</div>
			</div>
		@endif
		{{--<div class="form-group">
