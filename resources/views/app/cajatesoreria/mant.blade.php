...
{!! Form::model($caja, $formData) !!}	
    ...
    <div class="form-group" id="divDoctor" style="display: none">
        {!! Form::label('doctor', 'Médico:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
        <div class="col-lg-9 col-md-9 col-sm-9">
        {!! Form::hidden('doctor_id', null, array('id' => 'doctor_id')) !!}
            {!! Form::text('doctor', null, array('class' => 'form-control input-xs', 'id' => 'doctor', 'placeholder' => 'Ingrese Médico')) !!}
        </div>
    </div>
