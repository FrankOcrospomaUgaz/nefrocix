...
{!! Form::model($caja, $formData) !!}	
	...
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3">
			{!! Form::date('fecha', date('Y-m-d'), array('class' => 'form-control', 'id' => 'fecha')) !!}
		</div>
		{!! Form::label('numero', 'Nro:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
		<div class="col-lg-4 col-md-4 col-sm-4">
			{!! Form::text('numero', '', array('class' => 'form-control', 'id' => 'numero', 'readonly' => 'true')) !!}
		</div>
	</div>
    <div class="form-group">
		{!! Form::label('tipodocumento', 'Tipo:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
		<div class="col-lg-3 col-md-3 col-sm-3">
			{!! Form::select('tipodocumento', $cboTipoDoc, null, array('class' => 'form-control', 'id' => 'tipodocumento', 'onchange' => 'generarConcepto(this.value);')) !!}
		</div>
		{!! Form::label('concepto', 'Concepto:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
		<div class="col-lg-4 col-md-4 col-sm-4">
			{!! Form::select('concepto', $cboConcepto, null, array('class' => 'form-control', 'id' => 'concepto', 'onchange' => 'transferencia(this.value);')) !!}
		</div>
	</div>
	<div class="form-group" >
		...
		<div class="col-lg-3 col-md-3 col-sm-3 divCaja">
			{!! Form::select('caja', $cboCaja, 3, array('class' => 'form-control', 'id' => 'caja')) !!}
		</div>
    ...
    <div class="form-group" id="divPersona">
        ...
        {!! Form::hidden('person_id', null, array('id' => 'person_id')) !!}
			{!! Form::text('persona', null, array('class' => 'form-control', 'id' => 'persona', 'placeholder' => 'Ingrese Persona')) !!}
		</div>
    </div>
    <div class="form-group" id="divSocio" style="display: none">
        ...
        {!! Form::hidden('socio_id', null, array('id' => 'socio_id')) !!}
            {!! Form::text('socio', null, array('class' => 'form-control', 'id' => 'socio', 'placeholder' => 'Ingrese Socio')) !!}
        </div>
    </div>
    <div class="form-group" id="divDoctor" style="display: none">
        {!! Form::label('doctor', 'Médico:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
        <div class="col-lg-9 col-md-9 col-sm-9">
        {!! Form::hidden('doctor_id', null, array('id' => 'doctor_id')) !!}
            {!! Form::text('doctor', null, array('class' => 'form-control', 'id' => 'doctor', 'placeholder' => 'Ingrese Médico')) !!}
        </div>
    </div>
	<div class="form-group" id="divDocs" style="display: none;">
		{!! Form::label('doc', 'Médico:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label', 'style' => 'display:none')) !!}
        <div class="col-lg-9 col-md-9 col-sm-9" style="display: none;">
            {!! Form::text('busqueda', null, array('class' => 'form-control', 'id' => 'busqueda')) !!}
        </div>
    ...
    <div class="form-group">
		...
		<div class="col-lg-4 col-md-4 col-sm-4">
			{!! Form::text('total', 0, array('class' => 'form-control', 'id' => 'total')) !!}
		</div>
        {!! Form::label('rh', 'Doc.:', array('class' => 'hide col-lg-3 col-md-3 col-sm-3 control-label rh')) !!}
        <div class="col-lg-2 col-md-2 col-sm-2 rh hide">
            {!! Form::select('tipo', $cboTipo, 3, array('class' => 'form-control', 'id' => 'tipo', "style"=>"display:none;")) !!}
        </div>
        <div class="col-lg-2 col-md-2 col-sm-2 rh hide">
            {!! Form::text('rh', null, array('class' => 'form-control', 'id' => 'rh', "style">"display:none;")) !!}
        </div>
	</div>
    <div class="form-group">
		{!! Form::label('comentario', 'Comentario:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
		<div class="col-lg-9 col-md-9 col-sm-9">
			{!! Form::textarea('comentario', null, array('class' => 'form-control', 'id' => 'comentario', 'rows','8')) !!}
		</div>
	</div>
	<div class="form-group">
...
function agregarDoc(id,paciente,servicio,numero,pago){
    ...
    if(band){
        var a="<tr id='tr"+id+"'><td>"+numero+"</td><td>"+paciente+"</td><td>"+servicio+"</td><td id='tdPago"+id+"'>"+pago+"</td><td><input type='text' id='txtRecibo"+id+"' name='txtRecibo"+id+"' size='8' class='form-control' /></td><td><button type='button' title='Quitar' class='btn btn-danger btn-xs' onclick=\"quitarDoc('"+id+"')\"><i class='fa fa-minus'></i></button></td></tr>";
...
function validarTransferencia(entidad,valor){
    ...
    if($("#tipo").val()!="VR"){
        ...
        /*if($("#rh").val()=="" || rh.length<2){
            alertaG("Debe ingresar serie y numero correcto de documento");
            return false;
        }*/
        if($("#persona").val()=="") {
            alertaG("Debe ingresar una persona");
            return false;
        }
        if($("#total").val()==""||$("#total").val()==0) {
            alertaG("Debe ingresar un Total correcto");
            return false;
        }
    }
        ...
        $.ajax({
            ...
            success: function(a) {
                if(a=="OK"){
                    ...
                    alertaG("Lo siento... La caja no se ha aperturado");
                }
            }
        });        
    }else{
