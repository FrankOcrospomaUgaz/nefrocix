<div class="row">
				...
				@foreach($detalles as $detalle)
					...
					<tr>
						...
						<td style="font-size: 10px">
							{{ $detalle->persona->apellidopaterno }} {{ $detalle->persona->nombres }}
						</td>
	...
	<div class="col-lg-6 col-md-6 col-sm-6">			
		...
		<div class="form-group">
			...
			{!! Form::label('paciente', $movimiento->persona->apellidopaterno . ' ' . $movimiento->persona->apellidomaterno . ' ' . $movimiento->persona->nombres, array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label input-sm', 'style' => 'font-weight:normal;text-align:left')) !!}
			{!! Form::label('doctor', 'Referido', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label input-sm')) !!}
			@if(!is_null($movimiento->doctor))
				{!! Form::label('doctor', ($movimiento->doctor->apellidopaterno . ' ' . $movimiento->doctor->apellidomaterno . ' ' . $movimiento->doctor->nombres), array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label input-sm', 'style' => 'font-weight:normal;text-align:left')) !!}
			@endif
		</div>
		<hr>
