...
class EmployeeController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view($this->folderview.'.mant')->with(compact('employee', 'formData', 'entidad', 'boton', 'listar', 'departamento', 'provincia', 'distrito', 'cboDepartamento', 'cboProvincia', 'cboDistrito', 'birthdate', 'cboWorkertype', 'cboEspecialidad', 'cboTipomedico'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $error = DB::transaction(function() use($request){
            ...
            if($request->input('workertype_id')=="1"||$request->input('workertype_id')=="29"||$request->input('workertype_id')=="30"||$request->input('workertype_id')=="31") {
                $employee->rne = Libreria::obtenerParametro($request->input('rne'));
                $employee->cmp = Libreria::obtenerParametro($request->input('cmp'));
                $employee->especialidad_id = Libreria::obtenerParametro($request->input('especialidad_id'));
                $employee->tipomedico = Libreria::obtenerParametro($request->input('tipomedico'));
                $employee->save();
    ...
    public function edit($id, Request $request)
    {
        ...
        $cboTipomedico = array('E' => 'Especialista', 'G' => 'General');
        return view($this->folderview.'.mant')->with(compact('employee', 'formData', 'entidad', 'boton', 'departamento', 'provincia', 'distrito', 'cboDepartamento', 'cboProvincia', 'cboDistrito', 'listar', 'cboWorkertype', 'cboEspecialidad', 'cboTipomedico'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $error = DB::transaction(function() use($request, $id){
            ...
            if($request->input('workertype_id')=="1"||$request->input('workertype_id')=="29"||$request->input('workertype_id')=="30"||$request->input('workertype_id')=="31") {
                ...
                $rolillo = Rolpersona::where("rol_id", "=", 1)->where("person_id", "=", $employee->id)->first();
                ...
                $roles = Rolpersona::where("rol_id", "=", 1)->where("person_id", "=", $employee->id)->get();
