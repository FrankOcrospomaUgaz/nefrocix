...
class PersonController extends Controller
{
    public function employeesautocompleting($searching)
    {
        ...
        foreach ($list as $key => $value) {
            $data[] = array(
                            'label' => $value->person->apellidopaterno.' '.$value->person->apellidomaterno.' '.$value->person->nombres,
                            'id'    => $value->person->id,
                            'value' => $value->person->apellidopaterno.' '.$value->person->apellidomaterno.' '.$value->person->nombres,
                        );
        }
