...
Route::group(['middleware' => 'auth'], function () {
    ...
    //Consultas Mensuales
    Route::post('consultamensual/buscar', 'ConsultaMensualController@buscar')->name('consultamensual.buscar');
    Route::resource('consultamensual', 'ConsultaMensualController', array('except' => array('show')));
    Route::get('consultamensual/reporte1', 'ConsultaMensualController@reporte1')->name('consultamensual.reporte1');
    Route::get('consultamensual/reporte2', 'ConsultaMensualController@reporte2')->name('consultamensual.reporte2');
    Route::get('consultamensual/reporte3', 'ConsultaMensualController@reporte3')->name('consultamensual.reporte3');
    Route::get('consultamensual/reporte4', 'ConsultaMensualController@reporte4')->name('consultamensual.reporte4');

    Route::post('consultamensual/storereporte1', 'ConsultaMensualController@storereporte1')->name('consultamensual.storereporte1');
    Route::post('consultamensual/storereporte2', 'ConsultaMensualController@storereporte2')->name('consultamensual.storereporte2');
    Route::post('consultamensual/storereporte3', 'ConsultaMensualController@storereporte3')->name('consultamensual.storereporte3');
    Route::post('consultamensual/storereporte4', 'ConsultaMensualController@storereporte4')->name('consultamensual.storereporte4');

    Route::get('consultamensual/pdfReporte1', 'ConsultaMensualController@pdfReporte1')->name('consultamensual.pdfReporte1');
    Route::get('consultamensual/pdfReporte2', 'ConsultaMensualController@pdfReporte2')->name('consultamensual.pdfReporte2');
    Route::get('consultamensual/pdfReporte3', 'ConsultaMensualController@pdfReporte3')->name('consultamensual.pdfReporte3');
    Route::get('consultamensual/pdfReporte4', 'ConsultaMensualController@pdfReporte4')->name('consultamensual.pdfReporte4');

    Route::get('consultamensual/ImprimirReceta', 'ConsultaMensualController@ImprimirReceta')->name('consultamensual.ImprimirReceta');

    Route::get('consultamensual/ImprimirReciboProgramacionDiaria', 'ConsultaMensualController@ImprimirReciboProgramacionDiaria')->name('consultamensual.ImprimirReciboProgramacionDiaria');

    Route::get('consultamensual/ImprimirReciboRequerimientoNormal', 'ConsultaMensualController@ImprimirReciboRequerimientoNormal')->name('consultamensual.ImprimirReciboRequerimientoNormal');

    //Consultas Nefrologicas SIS
    Route::post('consultanefrologica/buscar', 'ConsultaNefrologicaController@buscar')->name('consultanefrologica.buscar');
    Route::resource('consultanefrologica', 'ConsultaNefrologicaController', array('except' => array('show')));

    Route::get('consultanefrologica/resultados', 'ConsultaNefrologicaController@resultados')->name('consultanefrologica.resultados');

    Route::post('consultanefrologica/storeresultados', 'ConsultaNefrologicaController@storeresultados')->name('consultanefrologica.storeresultados');

    Route::post('consultanefrologica/storeconfiguracionmensual', 'ConsultaNefrologicaController@storeconfiguracionmensual')->name('consultanefrologica.storeconfiguracionmensual');

    Route::get('consultanefrologica/confTodasConsultas', 'ConsultaNefrologicaController@confTodasConsultas')->name('consultanefrologica.confTodasConsultas');

    Route::get('consultanefrologica/programarmedicamentos', 'ConsultaNefrologicaController@programarmedicamentos')->name('consultanefrologica.programarmedicamentos');

    Route::post('consultanefrologica/storeprogramarmedicamentos', 'ConsultaNefrologicaController@storeprogramarmedicamentos')->name('consultanefrologica.storeprogramarmedicamentos');
    ...
    Route::get('usuario/cambiarPassword', 'UsuarioController@cambiarPassword')->name('usuario.cambiarPassword');
    Route::get('usuario/confirmarCambioPassword', 'UsuarioController@confirmarCambioPassword')->name('usuario.confirmarCambioPassword');
    ...
    Route::get('producto/productoAutocompletar/{searching}', 'ProductoController@productoAutocompletar')->name('producto.productoAutocompletar');
    ...
    Route::get('movimientoalmacen/corregirMovimientos/{listarluego}', 'MovimientoalmacenController@corregirMovimientos')->name('movimientoalmacen.corregirMovimientos');
    Route::post('movimientoalmacen/cuadrarMovimientos', 'MovimientoalmacenController@cuadrarMovimientos')->name('movimientoalmacen.cuadrarMovimientos');
    ...
    Route::post('requerimiento/generarNumeroRadmin', 'RequerimientoController@generarNumeroRadmin')->name('requerimiento.generarNumeroRadmin');
    Route::post('requerimiento/buscarproducto', 'RequerimientoController@buscarproducto')->name('requerimiento.buscarproducto');
    Route::post('requerimiento/buscarProveedor', 'RequerimientoController@buscarProveedor')->name('requerimiento.buscarProveedor');
    ...
    Route::get('historia/activar/{id}/{listarluego}', 'HistoriaController@activar')->name('historia.activar');
    Route::post('historia/guardarActivar/{id}', 'HistoriaController@guardarActivar')->name('historia.guardarActivar');
    ...
    Route::post('historia/validarDNI2', 'HistoriaController@validarDNI2')->name('historia.validarDNI2');
    ...
    Route::get('historia/observaciones/{id}/{listarluego}', 'HistoriaController@observaciones')->name('historia.observaciones');
    Route::post('historia/guardarobservaciones', 'HistoriaController@guardarobservaciones')->name('historia.guardarobservaciones');
    ...
    Route::get('historia/pdfhistoriaclinica', 'HistoriaController@pdfHistoriaclinica')->name('historia.pdfHistoriaClinica');
    Route::get('historia/pdfhistoriaclinica2', 'HistoriaController@pdfHistoriaclinica2')->name('historia.pdfHistoriaClinica2');

    Route::get('historia/reporteformato', 'HistoriaController@reporteformato')->name('historia.reporteformato');

    Route::get('historia/reporteHistoriaInicial', 'HistoriaController@reporteHistoriaInicial')->name('historia.reporteHistoriaInicial');

    //Para imprimir las citas
    Route::get('historia/pdfhistoria2', 'HistoriaController@pdfHistoria2')->name('historia.pdfHistoria2');

    //Para las hcinicial
    Route::get('historia/createhcinicial', array('as' => 'historia.createhcinicial', 'uses' => 'HistoriaController@createhcinicial'));
    Route::post('historia/storehcinicial', array('as' => 'historia.storehcinicial', 'uses' => 'HistoriaController@storehcinicial'));
    Route::get('historia/cargarCantidadEquipos', array('as' => 'historia.cargarCantidadEquipos', 'uses' => 'HistoriaController@cargarCantidadEquipos'));
    ...
    /* CIE */
    Route::post('cie/buscar', 'CieController@buscar')->name('cie.buscar');
    Route::get('cie/eliminar/{id}/{listarluego}', 'CieController@eliminar')->name('cie.eliminar');
    Route::resource('cie', 'CieController', array('except' => array('show')));
    ...
    /* CONFIGURACION */
    Route::post('configuracion/buscar', 'ConfiguracionController@buscar')->name('configuracion.buscar');
    Route::get('configuracion/eliminar/{id}/{listarluego}', 'ConfiguracionController@eliminar')->name('configuracion.eliminar');
    Route::resource('configuracion', 'ConfiguracionController', array('except' => array('show')));
    ...
    Route::post('ventaadmision/comprobarCitasHoy', 'VentaadmisionController@comprobarCitasHoy');
    ...
    Route::post('historiaclinica/nuevaHistoriaClinica', 'HistoriaClinicaController@nuevaHistoriaClinica')->name('historiaclinica.nuevaHistoriaClinica');
    ...
    Route::get('historiaclinica/inicializarTablaCies', 'HistoriaClinicaController@inicializarTablaCies')->name('historiaclinica.inicializarTablaCies');
    Route::get('historiaclinica/inicializarTablaCies2', 'HistoriaClinicaController@inicializarTablaCies2')->name('historiaclinica.inicializarTablaCies2');
    ...
    Route::post('historiaclinica/verSeguimiento', 'HistoriaClinicaController@verSeguimiento');

    //COMPROBACIONES IP
    Route::post('historiaclinica/cambiarEstadoIP', 'HistoriaClinicaController@cambiarEstadoIP');
    Route::post('historiaclinica/testearIPPendientes', 'HistoriaClinicaController@testearIPPendientes');
    ...
    Route::get('historiaclinica/reporte', 'HistoriaClinicaController@reporte')->name('historiaclinica.reporte');
    Route::post('historiaclinica/registrarFormato', 'HistoriaClinicaController@registrarFormato')->name('historiaclinica.registrarFormato');
    ...
    Route::get('historiaclinica/nomMedicamento', 'HistoriaClinicaController@nomMedicamento')->name('historiaclinica.nomMedicamento');

    Route::get('historiaclinica/comprobarMedico', 'HistoriaClinicaController@comprobarMedico')->name('historiaclinica.comprobarMedico');

    Route::get('historiaclinica/cerradoEspecial', 'HistoriaClinicaController@cerradoEspecial')->name('historiaclinica.cerradoEspecial');
    ...
    Route::get('historiaclinica/cargarMedicamentos', 'HistoriaClinicaController@cargarMedicamentos')->name('historiaclinica.cargarMedicamentos');

    /* FUA */
    Route::post('fua/buscar', 'FuaController@buscar')->name('fua.buscar');
    Route::get('fua/eliminar/{id}/{listarluego}', 'FuaController@eliminar')->name('fua.eliminar');
    Route::resource('fua', 'FuaController', array('except' => array('show')));
    Route::get('fua/comprobarCitasDiaEspecifico', 'FuaController@comprobarCitasDiaEspecifico')->name('fua.comprobarCitasDiaEspecifico');
    ...
    Route::get('historia/buscaEtiologia', 'HistoriaController@buscaEtiologia')->name('historia.buscaEtiologia');

    Route::get('pruebita', 'HistoriaClinicaController@pruebita');

    Route::get('historia/reporteHistoriaEnfermeria', 'HistoriaController@reporteHistoriaEnfermeria')->name('historia.reporteHistoriaEnfermeria');
    //Para las henfermeria
    Route::get('historia/createhenfermeria', array('as' => 'historia.createhenfermeria', 'uses' => 'HistoriaController@createhenfermeria'));
    Route::post('historia/storehenfermeria', array('as' => 'historia.storehenfermeria', 'uses' => 'HistoriaController@storehenfermeria'));

    //REPORTES NEFROCIX

    Route::resource('reporte/pacientesnuevos', 'ReporteController@pacientesnuevos');
    Route::resource('reporte/hospitalizadosmensuales', 'ReporteController@hospitalizadosmensuales');
    Route::resource('reporte/resultadosmensuales', 'ReporteController@resultadosmensuales');
    Route::resource('reporte/egresosmensuales', 'ReporteController@egresosmensuales');
    Route::resource('reporte/stockactual', 'ReporteController@stockactual');
    Route::resource('reporte/comprasalmacen', 'ReporteController@comprasalmacen');
    Route::resource('reporte/programacionesdiariashd', 'ReporteController@programacionesdiariashd');
    Route::resource('consultamensual/verconsolidadomedicamentos', 'ConsultaMensualController@verconsolidadomedicamentos');
    Route::resource('consultamensual/verresultadosporpaciente', 'ConsultaMensualController@verhistorialResultadosPorPaciente');
    Route::resource('reporte/registroaccesovascular', 'ReporteController@registroaccesovascular');
    Route::resource('reporte/controldescartefiltro', 'ReporteController@controldescartefiltro');
    Route::get('reporte/consultarStockNumero', 'ReporteController@consultarStockNumero');

    Route::get('consultamensual/cargaTablaverconsolidadoMedicamentos', 'ConsultaMensualController@cargaTablaverconsolidadoMedicamentos');

    Route::get('consultamensual/cargaTablaverhistorialResultadosPorPaciente', 'ConsultaMensualController@cargaTablaverhistorialResultadosPorPaciente');

    Route::get('reporte/analisisMensualesKtvTru', 'ReporteController@analisisMensualesKtvTru')->name('reporte.analisisMensualesKtvTru');
    Route::get('reporte/analisisMensualesKtvTru2', 'ReporteController@analisisMensualesKtvTru2')->name('reporte.analisisMensualesKtvTru2');
    Route::get('reporte/registroMensualPacientesNuevos', 'ReporteController@registroMensualPacientesNuevos')->name('reporte.registroMensualPacientesNuevos');
    Route::get('reporte/registroMensualPacientesHospitalizados', 'ReporteController@registroMensualPacientesHospitalizados')->name('reporte.registroMensualPacientesHospitalizados');
    Route::get('reporte/registroMensualEgresos', 'ReporteController@registroMensualEgresos')->name('reporte.registroMensualEgresos');
    Route::get('reporte/consultarStock', 'ReporteController@consultarStock')->name('reporte.consultarStock');
    Route::get('reporte/consultarKardex', 'ReporteController@consultarKardex')->name('reporte.consultarKardex');
    Route::get('reporte/consultarKardexConsolidado', 'ReporteController@consultarKardexConsolidado')->name('reporte.consultarKardexConsolidado');
    Route::get('reporte/consolidadoEvaluacionesExternasMensuales', 'ReporteController@consolidadoEvaluacionesExternasMensuales')->name('reporte.consolidadoEvaluacionesExternasMensuales');
    Route::get('reporte/historialResultadosPorPaciente', 'ReporteController@historialResultadosPorPaciente')->name('reporte.historialResultadosPorPaciente');
    Route::get('reporte/historialResultadosPorPaciente2', 'ReporteController@historialResultadosPorPaciente2')->name('reporte.historialResultadosPorPaciente2');
    Route::get('reporte/programacionMensualMedicamentos', 'ReporteController@programacionMensualMedicamentos')->name('reporte.programacionMensualMedicamentos');
    Route::get('reporte/reporteComprasAlmacen', 'ReporteController@reporteComprasAlmacen')->name('reporte.reporteComprasAlmacen');
    Route::get('reporte/reporteProgramacionesDiariasHD', 'ReporteController@reporteProgramacionesDiariasHD')->name('reporte.reporteProgramacionesDiariasHD');
    Route::get('reporte/consolidadoMedicamentos', 'ReporteController@consolidadoMedicamentos')->name('reporte.consolidadoMedicamentos');
    Route::get('reporte/consolidadoMedicamentosTodosPacientes', 'ReporteController@consolidadoMedicamentosTodosPacientes')->name('reporte.consolidadoMedicamentosTodosPacientes');
    Route::get('reporte/consolidadoDatosClinicosCalculoKTVHBPorPaciente', 'ReporteController@consolidadoDatosClinicosCalculoKTVHBPorPaciente')->name('reporte.consolidadoDatosClinicosCalculoKTVHBPorPaciente');
    Route::get('reporte/consolidadoDuracionSesiones', 'ReporteController@consolidadoDuracionSesiones')->name('reporte.consolidadoDuracionSesiones');
    Route::get('reporte/reporteregistroaccesovascular', 'ReporteController@reporteregistroaccesovascular')->name('reporte.reporteregistroaccesovascular');
    Route::get('reporte/reportecontroldescartefiltro', 'ReporteController@reportecontroldescartefiltro')->name('reporte.reportecontroldescartefiltro');

    Route::resource('consultanefrologica/cambiarDoctor', 'ConsultaNefrologicaController@cambiarDoctor');

    Route::post('consultanefrologica/cambiarDoctor2', 'ConsultaNefrologicaController@cambiarDoctor2')->name('consultanefrologica.cambiarDoctor2');

    /* BAJA */
    Route::post('baja/buscar', 'BajaController@buscar')->name('baja.buscar');
    Route::get('baja/eliminar/{id}/{listarluego}', 'BajaController@eliminar')->name('baja.eliminar');
    Route::resource('baja', 'BajaController', array('except' => array('show')));
    Route::get('baja/personautocompletar/{searching}', 'BajaController@personautocompletar')->name('baja.personautocompletar');
    Route::get('baja/evaluarPaciente', 'BajaController@evaluarPaciente')->name('baja.evaluarPaciente');

    Route::post('consultamensual/registrarReporteMedicamentos', 'ConsultaMensualController@registrarReporteMedicamentos');

    //Consultas Nefrologicas  ESSALUD
    Route::post('consultanefrologica2/buscar', 'ConsultaNefrologica2Controller@buscar')->name('consultanefrologica2.buscar');
    ...
    Route::get('consultanefrologica2/programarmedicamentos', 'ConsultaNefrologica2Controller@programarmedicamentos')->name('consultanefrologica2.programarmedicamentos');

    Route::post('consultanefrologica2/storeprogramarmedicamentos', 'ConsultaNefrologica2Controller@storeprogramarmedicamentos')->name('consultanefrologica2.storeprogramarmedicamentos');

    Route::get("prueba", "MovimientoalmacenController@prueba");

    Route::get('consultanefrologica/storemismosresultadosmesanterior', 'ConsultaNefrologicaController@storemismosresultadosmesanterior')->name('consultanefrologica.storemismosresultadosmesanterior');
    ...
    /* REQUERIMIENTO2 */
    Route::post('requerimiento2/buscar', 'Requerimiento2Controller@buscar')->name('requerimiento2.buscar');
    Route::get('requerimiento2/eliminar/{id}/{listarluego}', 'Requerimiento2Controller@eliminar')->name('requerimiento2.eliminar');
    Route::post('requerimiento2/generarNumero', 'Requerimiento2Controller@generarNumero')->name('requerimiento2.generarNumero');
    Route::post('requerimiento2/buscarproducto', 'Requerimiento2Controller@buscarproducto')->name('requerimiento2.buscarproducto');
    Route::resource('requerimiento2', 'Requerimiento2Controller');
    Route::get('requerimiento2/pdf/{id}', 'Requerimiento2Controller@pdf')->name('requerimiento2.pdfComprobante');

    Route::get('consultamensual/ImprimirReciboRequerimientoAdministrativo', 'ConsultaMensualController@ImprimirReciboRequerimientoAdministrativo')->name('consultamensual.ImprimirReciboRequerimientoAdministrativo');
});
